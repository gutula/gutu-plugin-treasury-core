...
- Package root: `framework/builtin-plugins/treasury-core`
- Service layer: `framework/builtin-plugins/treasury-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/treasury-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/treasury-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/treasury-core/src/ui`

## Safe assumptions

- Use `treasury-core` as the stable plugin identifier and `@plugins/treasury-core` as the package import name.
