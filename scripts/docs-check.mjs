...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/treasury-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-treasury-core:");
...
console.log("Documentation check passed for gutu-plugin-treasury-core.");
